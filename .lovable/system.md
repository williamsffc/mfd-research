...
**NEVER use text smaller than `type-caption` (20px) on slides!**

### Preferred: Use SlideText Component
```tsx
import { SlideText } from '@/components/slides/SlideText';

<SlideText variant="h2">Slide Title</SlideText>
<SlideText variant="body">Content text</SlideText>
<SlideText variant="caption">Smallest allowed</SlideText>
```
