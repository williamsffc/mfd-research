        ...
        <div className="flex-1 flex gap-8">
          ...
          <div className="w-64 flex flex-col">
              ...
              {timeSlots.map(time => (
                <button
                  ...
                  className={cn(
                    ...
                    !selectedDate && "bg-slate-100 text-slate-400 cursor-not-allowed",
                    selectedDate && "bg-slate-100 hover:bg-indigo-100 text-slate-700",
                    selectedTime === time && "bg-indigo-600 text-white hover:bg-indigo-700"
                  )}
                >
                  {time}
                </button>
            ...
            <button
              ...
              className={cn(
                "mt-4 w-full py-4 rounded-xl font-semibold flex items-center justify-center gap-2 transition-all",
